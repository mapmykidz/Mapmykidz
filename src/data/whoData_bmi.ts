...
// Official WHO BMI-for-age standards (0-2 years) - Boys
export const WHO_BMI_BOYS: LMSData[] = [
  { ageMonths: 0, L: -0.3053, M: 13.4069, S: 0.0956 },
  { ageMonths: 1, L: 0.2708, M: 14.9441, S: 0.09027 },
  { ageMonths: 2, L: 0.1118, M: 16.3195, S: 0.08677 },
  { ageMonths: 3, L: 0.0068, M: 16.8987, S: 0.08495 },
  { ageMonths: 4, L: -0.0727, M: 17.1579, S: 0.08378 },
  { ageMonths: 5, L: -0.137, M: 17.2919, S: 0.08296 },
  ...
  { ageMonths: 24, L: -0.6473, M: 15.7356, S: 0.07771 }
]

// Official WHO BMI-for-age standards (0-2 years) - Girls
export const WHO_BMI_GIRLS: LMSData[] = [
  { ageMonths: 0, L: -0.0631, M: 13.3363, S: 0.09272 },
  { ageMonths: 1, L: 0.3448, M: 14.5679, S: 0.09556 },
  { ageMonths: 2, L: 0.1749, M: 15.7679, S: 0.09371 },
  { ageMonths: 3, L: 0.0643, M: 16.3574, S: 0.09254 },
  { ageMonths: 4, L: -0.0191, M: 16.6703, S: 0.09166 },
  { ageMonths: 5, L: -0.0864, M: 16.8386, S: 0.09096 },
  ...
  { ageMonths: 24, L: -0.5989, M: 15.4052, S: 0.08545 }
]

// Helper functions to get WHO BMI data by gender
export const getWHOBMIData = (gender: 'male' | 'female') => {
  return gender === 'male' ? WHO_BMI_BOYS : WHO_BMI_GIRLS
}
